        ...
        <ul v-if="variations.length > 0" class="rounded overflow-hidden border border-gray-200">
            <li class="px-4 py-3 flex flex-wrap items-center gap-2.5 border-b last:border-none border-gray-200" v-for="variation in variations" :key="variation">
                <span class="flex-auto flex items-center">
                    <span v-for="(option, key) in variation.options" class="text-base font-medium capitalize tracking-wide whitespace-nowrap after:content-['\e071'] rtl:after:rotate-180 after:font-icon after:font-bold after:text-sm after:ml-1.5">
                        {{ key }} :: {{ option }}
                    </span>
                    <span class="text-base font-medium capitalize tracking-wide whitespace-nowrap after:content-['\e071'] rtl:after:rotate-180 after:font-icon after:font-bold after:text-sm after:ml-1.5">
